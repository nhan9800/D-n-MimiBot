...
// =====================================================================
// 🎨 BỘ EMOJI CUSTOM NEON TỰ ĐỘNG NẠP VÀO SERVER MAIN & TRANG TRÍ COMPONENT V2
// =====================================================================
const DECORATION_EMOJIS_DATA = {"shield": {"name": "mimi_shield", "fallback": "\ud83d\udee1\ufe0f", "dataUri": "data:image/png;base64,"}, "crown": {"name": "mimi_crown", "fallback": "\ud83d\udc51", "dataUri": "data:image/png;base64,"}, "music": {"name": "mimi_music", "fallback": "\ud83c\udfb5", "dataUri": "data:image/png;base64,"}, "verify": {"name": "mimi_verify", "fallback": "\u2705", "dataUri": "data:image/png;base64,"}, "fire": {"name": "mimi_fire", "fallback": "\ud83d\udd25", "dataUri": "data:image/png;base64,"}, "diamond": {"name": "mimi_diamond", "fallback": "\ud83d\udc8e", "dataUri": "data:image/png;base64,"}, "sparkles": {"name": "mimi_sparkles", "fallback": "\u2728", "dataUri": "data:image/png;base64,"}, "arrow": {"name": "mimi_arrow", "fallback": "\u2794", "dataUri": "data:image/png;base64,"}, "dot": {"name": "mimi_dot", "fallback": "\u2726", "dataUri": "data:image/png;base64,"}};
...
async function ensureDecorationEmojis(guild, client) {
    ...
    // Tìm Server Main (1517068246493429852) và Server hiện tại
    ...
    const targetGuild = mainGuild || guild;

    // Fetch toàn bộ emojis từ targetGuild và guild
    if (targetGuild) await targetGuild.emojis.fetch().catch(() => null);
    if (guild && guild.id !== targetGuild?.id) await guild.emojis.fetch().catch(() => null);
    ...
    for (const [key, item] of Object.entries(DECORATION_EMOJIS_DATA)) {
        if (customEmojiCache[item.name]) {
            results[key] = customEmojiCache[item.name];
            continue;
        }

        // 1. Tìm trong cache của Client, Target Guild hoặc Current Guild
        let existing = client?.emojis?.cache?.find(e => e.name === item.name) ||
                       targetGuild?.emojis?.cache?.find(e => e.name === item.name) ||
        ...
        if (existing) {
            ...
            logDetails.push(`✅ Có sẵn: ${item.name} (${existing.id})`);
            continue;
        }

        // 3. Nếu chưa có -> Tạo trực tiếp bằng DataURI Base64 vào targetGuild
        let createdEmoji = null;
        if (targetGuild) {
            try {
                createdEmoji = await targetGuild.emojis.create({ attachment: item.dataUri, name: item.name });
                if (createdEmoji) {
                    const formatted = `<${createdEmoji.animated ? 'a' : ''}:${createdEmoji.name}:${createdEmoji.id}>`;
                    customEmojiCache[item.name] = formatted;
                    results[key] = formatted;
                    logDetails.push(`🎨 Đã tạo trên ${targetGuild.name}: ${item.name} (${createdEmoji.id})`);
                    console.log(`🎨 [Auto-Emoji] Đã tạo emoji "${createdEmoji.name}" (${createdEmoji.id}) trên ${targetGuild.name}!`);
                    continue;
                }
            } catch (err) {
                console.warn(`⚠️ [Auto-Emoji] Lỗi tạo emoji "${item.name}" trên targetGuild:`, err?.message || err);
                logDetails.push(`❌ Lỗi tạo ${item.name} trên ${targetGuild.name}: ${err?.message || err}`);
            }
        }

        // Thử tạo vào Guild hiện tại nếu khác targetGuild
        if (!createdEmoji && guild && guild.id !== targetGuild?.id) {
            try {
                createdEmoji = await guild.emojis.create({ attachment: item.dataUri, name: item.name });
                if (createdEmoji) {
                    const formatted = `<${createdEmoji.animated ? 'a' : ''}:${createdEmoji.name}:${createdEmoji.id}>`;
                    customEmojiCache[item.name] = formatted;
                    results[key] = formatted;
                    logDetails.push(`🎨 Đã tạo trên ${guild.name}: ${item.name} (${createdEmoji.id})`);
                    continue;
                }
            } catch (err) {
                console.warn(`⚠️ [Auto-Emoji] Lỗi tạo emoji trên ${guild.name}:`, err?.message || err);
                logDetails.push(`❌ Lỗi tạo ${item.name} trên ${guild.name}: ${err?.message || err}`);
            }
        }

        // Thử tạo vào Application Emojis
        if (!createdEmoji && client?.application) {
            try {
                const appCreated = await client.application.emojis.create({ attachment: item.dataUri, name: item.name });
                if (appCreated) {
                    const formatted = `<${appCreated.animated ? 'a' : ''}:${appCreated.name}:${appCreated.id}>`;
                    customEmojiCache[item.name] = formatted;
                    results[key] = formatted;
                    logDetails.push(`🎨 Tạo Application Emoji ${item.name} -> ${formatted}`);
                    continue;
                }
            } catch (err) {
                console.warn(`⚠️ [Auto-Emoji] Lỗi tạo Application Emoji:`, err?.message || err);
            }
        }

        results[key] = item.fallback;
        logDetails.push(`⚠️ Dùng fallback cho ${item.name} -> ${item.fallback}`);
    }

    return { emojis: results, logs: logDetails };
}

async function buildChangelogAnnouncement(guild, client) {
    const { emojis: em, logs } = await ensureDecorationEmojis(guild, client);
    ...
    return { payload: { embeds: [embed], components: [row1, row2] }, logs };
}
...
⏱️ **Từ:** <t:${Math.floor(tData.afk.timestamp / 1000)}:R>` }).catch(() => null);
    ...
    if ((command === 'miannounce' || command === 'mithongbao') && (message.author.id === OWNER_ID || message.member?.permissions?.has(PermissionFlagsBits.Administrator))) {
        ...
        const { payload, logs } = await buildChangelogAnnouncement(channel.guild || message.guild, message.client);
        await channel.send(payload);
        return message.reply(`✅ **Đã phát sóng thông báo V2.3 Component & Separator!**\n\n📊 **Chi tiết nạp Emoji Custom:**\n${logs.join('\n')}`);
    }
